...
- Upload a product photo → Generate dynamic product showcase
- Submit a landscape image → Create atmospheric scene with movement
- Provide character art → Animate with natural motion and dialogue
